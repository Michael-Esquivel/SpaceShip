...
BULLET_HIT_SOUND = pygame.mixer.Sound('/Users/Usuario/Desktop/Python_New/Python-Game/Spaceship Battle/Assets/Grenade+1.wav')
BULLET_FIRE_SOUND = pygame.mixer.Sound('/Users/Usuario/Desktop/Python_New/Python-Game/Spaceship Battle/Assets/Shot.wav')
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('/Users/Usuario/Desktop/Python_New/Python-Game/Spaceship Battle/Assets', 'spaceship_yellow.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('/Users/Usuario/Desktop/Python_New/Python-Game/Spaceship Battle/Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 270)

SPACE = pygame.transform.scale(pygame.image.load(   #Background
    os.path.join('/Users/Usuario/Desktop/Python_New/Python-Game/Spaceship Battle/Assets', 'space.png')), (WIDTH, HEIGHT))
...
def handle_bullets(yellow_bullets, red_bullets, yellow, red):
    for bullet in yellow_bullets:
        ...
        if red.colliderect(bullet):
            pygame.event.post(pygame.event.Event(RED_HIT))  #Disminuye vida al rojo
...
#Función principal
def main():
    #Estos rectángulos representan las spaceship, basicamente Mascaras
